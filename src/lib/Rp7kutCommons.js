...
// Menu
// ================================================================================================================
export function Rp7kutMenu({ githubUser }) {
...
Rp7kutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;
  .rp7kutMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
function Rp7kutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="rp7kutMenuProfileSidebar">
      <div>
...
// Rp7kutProfileSidebarMenuDefault
// ================================================================================================================
export function Rp7kutProfileSidebarMenuDefault() {
  return (
...
Rp7kutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
